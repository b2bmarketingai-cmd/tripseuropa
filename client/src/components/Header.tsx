  ...
  es: {
    ...
    byGroup: {
      ...
      items: [
        ...
        {
          name: "Amigos y Tours Privados",
          href: "/travel-style/friends-private",
        },
      ],
    },
  },
...
export function Header() {
  ...
  const labels = {
    ...
    asistenciaChat: {
      es: "Asistencia por chat",
      en: "Chat Support",
      pt: "Suporte por chat",
    },
    centroAyuda: {
      es: "Centro de Ayuda y FAQs",
      en: "Help Center & FAQs",
      pt: "Central de Ajuda e FAQs",
    },
    centroAyudaMobile: {
      es: "Centro de Ayuda",
      en: "Help Center",
    ...
    eresAgente: {
      es: "¿Eres agente de viajes?",
      en: "Are you a travel agent?",
      pt: "É agente de viagens?",
    },
    registrarse: { es: "Registrarse", en: "Register", pt: "Registrar-se" },
    tripBySeason: {
      es: "Viaje Por Temporada",
      en: "Trip By Season",
      pt: "Viagem por Temporada",
    },
    tripByInterest: {
      es: "Viaje Por Interés",
      en: "Trip By Interest",
      pt: "Viagem por Interesse",
    },
    tripByGroup: {
      es: "Viaje Por Grupo",
      en: "Trip By Group",
    ...
    agenteDesc: {
      es: "Ofrece a tus clientes paquetes de viaje inolvidables a precios competitivos.",
      en: "Offer your clients unforgettable travel packages at competitive prices.",
      pt: "Ofereça aos seus clientes pacotes de viagem inesquecíveis a preços competitivos.",
    },
  };
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-[80px] md:h-[100px]">
            <div className="hidden lg:flex items-center gap-6">
              <DropdownMenu
                open={activeDropdown === "destinos"}
                onOpenChange={(open) =>
                  setActiveDropdown(open ? "destinos" : null)
                }
              >
                ...
                <DropdownMenuContent
                  align="start"
                  className="w-64 bg-white p-2 max-h-96 overflow-y-auto"
                >
                  {DESTINATIONS_MENU[currentLang][0].items.map((item, idx) => {
                    const slugMap: Record<string, string> = {
                      ...
                      Escocia: "scotland",
                      España: "spain",
                      "Estados Balticos": "baltic-states",
                      Finlandia: "finland",
                      Francia: "france",
                      Grecia: "greece",
                      Hungria: "hungary",
                      ...
                      Croácia: "croatia",
                      Escócia: "scotland",
                      "Estados Bálticos": "baltic-states",
                      Finlândia: "finland",
                      Grécia: "greece",
                      Islândia: "iceland",
                      Itália: "italy",
                      ...
                      >
                        <Link
                          href={getLocalizedPath(
                            `/destinations/${slugMap[item] || item.toLowerCase().replace(/\s+/g, "-")}`,
                          )}
                          className="w-full"
                        >
                          {item}
              ...
              <DropdownMenu
                open={activeDropdown === "estilo"}
                onOpenChange={(open) =>
                  setActiveDropdown(open ? "estilo" : null)
                }
              >
                <DropdownMenuTrigger asChild>
                  <button
                ...
                <DropdownMenuContent
                  align="start"
                  className="w-[600px] bg-white p-4"
                  sideOffset={8}
                >
                  <Tabs defaultValue="season" className="w-full">
                    <TabsList className="grid w-full grid-cols-3 mb-4 bg-muted">
                      <TabsTrigger
                        value="season"
                        className="text-xs data-[state=active]:bg-foreground data-[state=active]:text-background rounded-md"
                      >
                    ...
                    <TabsContent value="season" className="mt-0">
                      <p className="text-sm font-medium text-muted-foreground mb-3">
                        {labels.tripBySeason[currentLang]}
                      </p>
                      <div className="grid grid-cols-2 gap-2">
                        {TRAVEL_STYLE_CATEGORIES[
                          currentLang
                        ].bySeason.items.map((item, idx) => (
                          <Link
                            key={idx}
                            href={item.href}
                            className="text-sm text-foreground hover:text-accent py-1.5 transition-colors"
                    ...
                    <TabsContent value="interest" className="mt-0">
                      <p className="text-sm font-medium text-muted-foreground mb-3">
                        {labels.tripByInterest[currentLang]}
                      </p>
                      <div className="grid grid-cols-3 gap-2">
                        {TRAVEL_STYLE_CATEGORIES[
                          currentLang
                        ].byInterest.items.map((item, idx) => (
                          <Link
                            key={idx}
                            href={item.href}
                            className="text-sm text-foreground hover:text-accent py-1.5 transition-colors"
                    ...
                    <TabsContent value="group" className="mt-0">
                      <p className="text-sm font-medium text-muted-foreground mb-3">
                        {labels.tripByGroup[currentLang]}
                      </p>
                      <div className="grid grid-cols-2 gap-2">
                        {TRAVEL_STYLE_CATEGORIES[currentLang].byGroup.items.map(
                          (item, idx) => (
                            <Link
                              key={idx}
                              href={item.href}
              ...
              <DropdownMenu
                open={activeDropdown === "ofertas"}
                onOpenChange={(open) =>
                  setActiveDropdown(open ? "ofertas" : null)
                }
              >
                <DropdownMenuTrigger asChild>
                  <button
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-64 bg-white p-2">
                  <DropdownMenuItem asChild className="cursor-pointer gap-3">
                    <Link
                      href={getLocalizedPath("/travel-assistant")}
            ...
            <div className="container px-4 py-6 space-y-4">
                ...
                <div className="pl-4 py-2 space-y-4">
                  <div>
                    ...
                    <div className="space-y-1">
                      {TRAVEL_STYLE_CATEGORIES[currentLang].bySeason.items.map(
                        (item, idx) => (
                          <Link
                            key={idx}
                            href={item.href}
              ...
              <details className="group">
                ...
                <div className="pl-4 py-2 space-y-2">
                  <Link
                    href={getLocalizedPath("/travel-assistant")}
                    className="flex items-center gap-2 py-1 text-gray-600 hover:text-primary w-full text-left"
                    onClick={() => setIsOpen(false)}
                  >
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <Tabs defaultValue="viajero" className="w-full">
            ...
            <TabsContent value="viajero" className="space-y-4 pt-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="password-viajero">
                  {labels.contrasena[currentLang]}
                </Label>
