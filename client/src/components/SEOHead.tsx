...
export const homePageSEO: Record<string, LocalizedSEO> = {
  es: {
    ...
    keywords: "viajes a europa, paquetes europa, viaje europa desde colombia, europa desde mexico, tours europa español, visa schengen, luna de miel europa"
  },
  "es-MX": {
    title: "Viajes a Europa desde México - Trips Europa",
    description: "Paquetes turísticos a Europa para mexicanos. Vuelos, hoteles y tours personalizados. Reserva ahora con las mejores ofertas.",
    keywords: "viajes europa desde mexico, paquetes europa mexico, tours europa mexicanos"
  },
  "es-CO": {
    title: "Viajes a Europa desde Colombia - Trips Europa",
    description: "Paquetes turísticos a Europa para viajeros colombianos. Organiza tu viaje con expertos. Mejores precios garantizados.",
    keywords: "viajes europa desde colombia, paquetes europa colombia, visa schengen colombianos"
  },
  "es-AR": {
    title: "Viajes a Europa desde Argentina - Trips Europa",
    description: "Paquetes turísticos a Europa para argentinos. Vuelos desde Buenos Aires, tours en español y ciudadanía italiana/española.",
    keywords: "viajes europa desde argentina, paquetes europa argentina, ciudadania italiana argentina"
  },
  "es-PE": {
    title: "Viajes a Europa desde Perú - Trips Europa",
    description: "Paquetes turísticos a Europa para peruanos. Vuelos desde Lima, hoteles de lujo y experiencias únicas.",
    keywords: "viajes europa desde peru, paquetes europa peru, tours europa peruanos"
  },
  "pt-BR": {
    title: "Viagens para Europa - Trips Europa Brasil",
    description: "Pacotes turísticos para a Europa. Passagens aéreas, hotéis e passeios personalizados. Reserve online com as melhores ofertas.",
    keywords: "viagem europa brasil, pacotes europa brasil, passagens europa"
  },
  en: {
    title: "European Travel Packages - Trips Europa",
    description: "Premium travel agency specializing in European tour packages. Flights, 5-star hotels, Spanish-speaking guides, and Schengen visa assistance. From $1,200 USD.",
    keywords: "europe travel packages, european tours, flights to europe, luxury europe travel"
  }
};
...
export function PackagesPageSEO() {
  ...
  return (
    <SEOHead
      ...
      url="https://tripseuropa.co/packages"
      alternateUrls={hreflangUrls}
    />
  );
}
...
export function ColombiaPageSEO() {
  ...
  return (
    <SEOHead
      ...
      url="https://tripseuropa.co/desde-colombia"
      locale="es_CO"
      alternateUrls={hreflangUrls}
    />
  );
...
export function MexicoPageSEO() {
  ...
  return (
    <SEOHead
      ...
      url="https://tripseuropa.co/desde-mexico"
      locale="es_MX"
      alternateUrls={hreflangUrls}
    />
  );
...
export function BrazilPageSEO() {
  ...
  return (
    <SEOHead
      ...
      url="https://tripseuropa.co/desde-brasil"
      locale="pt_BR"
      alternateUrls={hreflangUrls}
    />
  );
...
export function PanamaPageSEO() {
  ...
  return (
    <SEOHead
      ...
      url="https://tripseuropa.co/desde-panama"
      locale="es_PA"
      alternateUrls={hreflangUrls}
    />
  );
...
export function ArgentinaPageSEO() {
  ...
  return (
    <SEOHead
      ...
      url="https://tripseuropa.co/desde-argentina"
      locale="es_AR"
      alternateUrls={hreflangUrls}
    />
  );
...
export function PeruPageSEO() {
  ...
  return (
    <SEOHead
      ...
      url="https://tripseuropa.co/desde-peru"
      locale="es_PE"
      alternateUrls={hreflangUrls}
    />
  );
...
export function CostaRicaPageSEO() {
  ...
  return (
    <SEOHead
      ...
      url="https://tripseuropa.co/desde-costa-rica"
      locale="es_CR"
      alternateUrls={hreflangUrls}
    />
  );
...
export function DestinationsPageSEO() {
  ...
  return (
    <SEOHead
      ...
      url="https://tripseuropa.co/destinos"
      alternateUrls={hreflangUrls}
    />
  );
}
...
export function ContactPageSEO() {
  ...
  return (
    <SEOHead
      ...
      url="https://tripseuropa.co/contact"
      alternateUrls={hreflangUrls}
    />
  );
}
...
export function TestimonialsPageSEO() {
  ...
  return (
    <SEOHead
      ...
      url="https://tripseuropa.co/testimonios"
      alternateUrls={hreflangUrls}
    />
  );
}
