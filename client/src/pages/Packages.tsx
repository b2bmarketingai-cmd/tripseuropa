...
const PACKAGE_CATEGORIES = [
  ...
  { id: "classic", label: { es: "Clásica", en: "Classic", pt: "Classica" }, icon: Star },
...
const PACKAGES = [
  ...
  },
  {
    ...
    title: { es: "España Rápida", en: "Quick Spain" },
    desc: { es: "Madrid y Barcelona en 7 dias. Arte, gastronomía, flamenco y playas mediterraneas.", en: "Madrid and Barcelona in 7 days. Art, gastronomy, flamenco and Mediterranean beaches." },
    priceUSD: 1350,
    days: 7,
    nights: 6,
  ...
  },
  {
    ...
    title: { es: "Europa Clásica Completa", en: "Complete Classic Europe" },
  ...
  },
  {
    ...
    title: { es: "Mediterraneo Mágico", en: "Magical Mediterranean" },
    desc: { es: "Barcelona, Florencia, Roma y Costa Amalfitana. Sol, arte, vino y gastronomía italiana.", en: "Barcelona, Florence, Rome and Amalfi Coast. Sun, art, wine and Italian gastronomy." },
    priceUSD: 2400,
    days: 12,
    nights: 11,
  ...
  },
  {
    ...
    category: "romantic",
    image: "https://images.unsplash.com/photo-1516483638261-f4dbaf036963?q=70&w=800&auto=format&fit=crop",
    title: { es: "Luna de Miel Romántica", en: "Romantic Honeymoon" },
    desc: { es: "Paris, Castillos del Loira, Suiza e Italia. Cenas privadas, spa y momentos únicos.", en: "Paris, Loire Castles, Switzerland and Italy. Private dinners, spa and unique moments." },
    priceUSD: 4800,
    days: 10,
    nights: 9,
    destinations: ["Paris", "Castillos Loire", "Suiza", "Venecia"],
    features: ["Suites románticas", "Cenas privadas", "Spa y wellness", "Sorpresas especiales"],
