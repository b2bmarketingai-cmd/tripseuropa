...
const FAVORITES = [
  ...
  },
  {
    ...
    title: { es: "Portugal Completo", en: "Complete Portugal" },
    price: "1,299",
    taxes: "799",
  },
  {
    ...
    title: { es: "Primavera en Europa", en: "Spring in Europe" },
    price: "1,599",
    taxes: "799",
  },
  {
            ...
            >
              <div className="relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
                  <h3 className="font-display font-bold text-lg mb-2">{fav.title[lang]}</h3>
                  ...
                  <div className="flex items-baseline gap-1 flex-wrap">
                    ...
                    <span className="text-sm text-white/70">+ {fav.taxes} {content[lang].taxes}</span>
                  </div>
