...
export const BLOG_POSTS_SIMPLE: SimpleBlogPost[] = [
  ...
  },
  {
    ...
    excerpt: { es: "Paris, Barcelona, Roma y mas. El circuito clásico que combina lo mejor de tres paises iconicos.", en: "Paris, Barcelona, Rome and more. The classic circuit combining the best of three iconic countries." },
    category: "destinos",
    categoryLabel: { es: "Destinos", en: "Destinations" },
    date: "29 Dic 2024",
    readTime: 12,
  ...
  },
  {
    ...
    excerpt: { es: "Florencia, Siena, Chianti y pueblos medievales. La forma mas auténtica de vivir la Toscana italiana.", en: "Florence, Siena, Chianti and medieval towns. The most authentic way to experience Italian Tuscany." },
    category: "lujo",
  ...
  },
  {
    ...
    excerpt: { es: "Comparativa completa: clima, costo, atracciones, gastronomía y ambiente. Te ayudamos a decidir.", en: "Complete comparison: weather, cost, attractions, gastronomy and atmosphere. We help you decide." },
    category: "destinos",
    categoryLabel: { es: "Destinos", en: "Destinations" },
    date: "20 Dic 2024",
    readTime: 9,
  ...
  },
  {
    ...
    excerpt: { es: "Mejores épocas, aerolineas, buscadores y trucos para ahorrar hasta 40% en tus vuelos.", en: "Best times, airlines, search engines and tricks to save up to 40% on your flights." },
    category: "dinero",
    categoryLabel: { es: "Dinero", en: "Money" },
    date: "14 Dic 2024",
    readTime: 10,
  ...
  },
  {
    ...
    excerpt: { es: "Mejores horarios, barrios menos visitados, islas secretas y como disfrutar Venecia auténtica.", en: "Best times, less visited neighborhoods, secret islands and how to enjoy authentic Venice." },
    category: "consejos",
    categoryLabel: { es: "Consejos", en: "Tips" },
    date: "28 Nov 2024",
    readTime: 7,
  ...
  },
  {
    ...
    excerpt: { es: "Noruega, Islandia, Finlandia y Suecia. Mejor época, lugares y consejos para ver auroras.", en: "Norway, Iceland, Finland and Sweden. Best time, places and tips for seeing auroras." },
    category: "destinos",
    categoryLabel: { es: "Destinos", en: "Destinations" },
    date: "24 Nov 2024",
    readTime: 9,
  ...
  },
  {
    ...
    excerpt: { es: "Bodegas, catas, paisajes y gastronomía. La guia definitiva para los amantes del vino italiano.", en: "Wineries, tastings, landscapes and gastronomy. The ultimate guide for Italian wine lovers." },
    category: "gastronomía",
    categoryLabel: { es: "Gastronomia", en: "Gastronomy" },
    date: "22 Nov 2024",
    readTime: 10,
  ...
  },
  {
    ...
    excerpt: { es: "No cometas estos errores clásicos de viajeros primerizos. Ahorra tiempo, dinero y frustraciones.", en: "Don't make these classic first-time traveler mistakes. Save time, money and frustrations." },
    category: "consejos",
    categoryLabel: { es: "Consejos", en: "Tips" },
    date: "10 Nov 2024",
    readTime: 8,
  ...
  },
  {
    ...
    excerpt: { es: "Opera de Viena, conciertos en palacios, casa de Mozart. Guia para amantes de la musica clásica.", en: "Vienna Opera, palace concerts, Mozart's house. Guide for classical music lovers." },
    category: "lujo",
    categoryLabel: { es: "Lujo", en: "Luxury" },
    date: "10 Oct 2024",
    readTime: 9,
