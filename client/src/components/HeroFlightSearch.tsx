...
const AIRPORTS = [
  ...
  { code: "POS", city: "Puerto España", country: "Trinidad (Caribe)", countryCode: "CB" },
  ...
  // ES - España
  { code: "MAD", city: "Madrid", country: "España", countryCode: "ES" },
  { code: "BCN", city: "Barcelona", country: "España", countryCode: "ES" },
  { code: "VLC", city: "Valencia", country: "España", countryCode: "ES" },
  { code: "AGP", city: "Malaga", country: "España", countryCode: "ES" },
  { code: "SVQ", city: "Sevilla", country: "España", countryCode: "ES" },
  { code: "PMI", city: "Palma de Mallorca", country: "España", countryCode: "ES" },
  { code: "TFS", city: "Tenerife Sur", country: "España", countryCode: "ES" },
  { code: "LPA", city: "Gran Canaria", country: "España", countryCode: "ES" },
  { code: "BIO", city: "Bilbao", country: "España", countryCode: "ES" },
  { code: "ALC", city: "Alicante", country: "España", countryCode: "ES" },
  { code: "IBZ", city: "Ibiza", country: "España", countryCode: "ES" },
  { code: "SDR", city: "Santander", country: "España", countryCode: "ES" },
  { code: "ZAZ", city: "Zaragoza", country: "España", countryCode: "ES" },
  // DE - Alemania
