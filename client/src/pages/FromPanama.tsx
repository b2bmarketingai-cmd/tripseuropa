        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/contact">
                <Button size="lg" className="bg-blue-500 text-white font-bold hover:bg-blue-600" data-testid="button-panama-cta">
      ...
      <section className="py-12 bg-blue-500" data-testid="section-panama-cta">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/contact">
              <Button size="lg" className="bg-white text-blue-600 hover:bg-white/90" data-testid="button-panama-contact">
