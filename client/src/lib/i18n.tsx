...
const translations: Record<Language, Record<string, string>> = {
  ...
  pt: {
    ...
    // Hero
    "hero.badge": "Agencia Premium #1 America Latina - Europa",
    "hero.title1": "Viva a Europa",
    "hero.titleHighlight": "Como Nunca Antes",
    "hero.title2": "",
    "hero.subtitle": "Experiencias exclusivas projetadas para viajantes exigentes. Voos diretos, hoteis de luxo e momentos inesqueciveis.",
    "hero.years": "15K+",
    "hero.experience": "Viajantes Felizes",
    "hero.travelers": "50+",
    "hero.happyTravelers": "Destinos Europa",
    "hero.rating": "Satisfacao",
    "hero.satisfaction": "98%",
    
    // Contact Form
    "contact.title": "Solicite um Orcamento Gratis",
    ...
    "contact.successMessage": "Um consultor de viagens entrara em contato nas proximas 24 horas.",
    "contact.services.flights": "Voos para Europa",
    "contact.services.packages": "Pacotes Completos",
    "contact.services.hotels": "Reserva de Hoteis",
    ...
    "features.subtitle": "Somos a agencia lider em viagens para Europa. Conhecemos cada destino como a palma da nossa mao.",
    "features.flights": "Melhores Tarifas Aereas",
    "features.flightsDesc": "Acesso a tarifas exclusivas com as principais companhias aereas europeias.",
    "features.hotels": "Hoteis Selecionados",
    "features.hotelsDesc": "Hospedagens verificadas e com as melhores localizacoes em cada cidade.",
    "features.support": "Suporte 24/7 em Portugues",
    "features.supportDesc": "Assistencia permanente durante toda sua viagem, quando precisar.",
    "features.payments": "Pagamentos Flexiveis",
    "features.paymentsDesc": "Financie sua viagem em parcelas sem juros com cartao de credito.",
    ...
    "packages.title": "Experiencias Projetadas para Voce",
    "packages.subtitle": "Pacotes completos com voos, hoteis, traslados e experiencias unicas",
    "packages.viewAll": "Ver Todos os Pacotes",
    "packages.perPerson": "por pessoa",
    "packages.quote": "Orcamento",
    "packages.bestSeller": "Mais Vendido",
    
    // Testimonials
    "testimonials.badge": "Depoimentos",
    "testimonials.title": "O Que Nossos Viajantes Dizem",
    "testimonials.subtitle": "Milhares de viajantes confiaram em nos para viver experiencias inesqueciveis na Europa.",
    
    // Process
    "process.badge": "Como Funciona",
    "process.title": "Sua Viagem em 4 Passos",
    "process.step1.title": "Conte-nos seu sonho",
    "process.step1.desc": "Preencha o formulario com suas preferencias e destinos dos sonhos.",
    "process.step2.title": "Receba sua proposta",
    "process.step2.desc": "Em 24 horas voce recebera um roteiro personalizado com opcoes.",
    "process.step3.title": "Reserve e pague",
    "process.step3.desc": "Confirme sua viagem com pagamentos seguros e opcoes de financiamento.",
    ...
    "cta.titleHighlight": "Europa",
    "cta.subtitle": "Deixe seus dados e um consultor especializado entrara em contato para criar juntos a viagem dos seus sonhos. Sem compromisso, sem custo.",
    "cta.formTitle": "Solicite seu Orcamento Gratis",
    "cta.formSubtitle": "Resposta garantida em menos de 24 horas",
    
    // Flight Search
    "search.flights": "Voos",
    "search.hotels": "Hoteis",
    ...
    "search.searching": "Buscando...",
    "search.popular": "Populares:",
    "search.results": "Voos Disponiveis",
    ...
    // Footer
    "footer.description": "Especialistas em viagens para Europa. Pacotes exclusivos, voos, hoteis e experiencias unicas projetadas para voce.",
    "footer.destinations": "Destinos Populares",
    "footer.services": "Nossos Servicos",
    "footer.contact": "Contate-nos",
    "footer.iata": "Agencia Credenciada IATA",
    "footer.ssl": "Pagamentos 100% Seguros",
    "footer.support": "Suporte em Portugues",
    "footer.rights": "Todos os direitos reservados.",
    "footer.privacy": "Politica de Privacidade",
    "footer.tools": "Ferramentas de Viagem",
    "footer.policies": "Politicas",
    "footer.cookies": "Politica de Cookies",
    
    // Contact Info
    "contactInfo.call": "Ligue para nos",
    "contactInfo.write": "Escreva para nos",
    ...
    "form.validation.emailInvalid": "Insira um e-mail valido",
    "form.validation.messageMin": "A mensagem deve ter pelo menos 10 caracteres",
    "form.errorSend": "Nao foi possivel enviar a mensagem. Tente novamente.",
    ...
    // Packages data
    "pkg.honeymoon.title": "Lua de Mel na Italia",
    "pkg.honeymoon.desc": "10 dias percorrendo Roma, Florenca, Veneza e a Costa Amalfitana. Inclui jantares romanticos e passeios privados.",
    "pkg.adventure.title": "Aventura nos Alpes",
    "pkg.adventure.desc": "8 dias entre Suica, Austria e norte da Italia. Trens panoramicos, trilhas e paisagens de sonho.",
    "pkg.cultural.title": "Capitais Imperiais",
    "pkg.cultural.desc": "12 dias por Viena, Praga e Budapeste. Arte, musica classica, palacios e a melhor gastronomia centro-europeia.",
    "pkg.feature.flights": "Voos incluidos",
    "pkg.feature.hotels5": "Hoteis 5 estrelas",
    "pkg.feature.transfers": "Traslados privados",
    "pkg.feature.tours": "Passeios exclusivos",
    "pkg.feature.swissPass": "Swiss Travel Pass",
    "pkg.feature.mountainHotels": "Hoteis de montanha",
    "pkg.feature.cableCars": "Telefericos incluidos",
    "pkg.feature.localGuide": "Guia local",
    "pkg.feature.flightsTrain": "Voos + trem",
    "pkg.feature.centralHotels": "Hoteis centrais",
    "pkg.feature.concerts": "Concertos e opera",
    "pkg.feature.guidedTours": "Passeios guiados",
    "pkg.tag.romantic": "Romantico",
    "pkg.tag.adventure": "Aventura",
    "pkg.tag.cultural": "Cultural",
    
    // Testimonials data
    "testimonial.1.name": "Maria Gonzalez",
    "testimonial.1.location": "Sao Paulo, Brasil",
    "testimonial.1.trip": "Paris e Amsterda",
    "testimonial.1.tripLabel": "Viagem realizada",
    "testimonial.1.text": "Experiencia incrivel. A equipe da Trips Europa organizou cada detalhe da nossa viagem a Paris. Os hoteis foram espetaculares e o servico impecavel.",
    "testimonial.2.name": "Carlos Ramirez",
    "testimonial.2.location": "Rio de Janeiro, Brasil",
    "testimonial.2.trip": "Tour Italia Completo",
    "testimonial.2.tripLabel": "Viagem realizada",
    "testimonial.2.text": "Viajamos em familia para a Italia e foi perfeito. A atencao personalizada e os passeios privados fizeram a diferenca. 100% recomendado.",
    "testimonial.3.name": "Ana Martinez",
    "testimonial.3.location": "Brasilia, Brasil",
    "testimonial.3.trip": "Barcelona e Madrid",
    "testimonial.3.tripLabel": "Viagem realizada",
    "testimonial.3.text": "O programa VIP Club e excelente. Ja viajei 3 vezes com eles e cada experiencia supera a anterior. Profissionalismo e luxo garantidos.",
    ...
    "footer.dest.rome": "Roma",
    "footer.dest.london": "Londres",
    "footer.dest.amsterdam": "Amsterda",
    
    // Footer services
    "footer.service.flights": "Voos",
    "footer.service.hotels": "Hoteis",
    ...
    // Search placeholders and messages
    "search.originPlaceholder": "Sao Paulo, Brasil",
    "search.destinationPlaceholder": "Paris, Franca",
    "search.missingInfo": "Informacao incompleta",
    ...
    // Services Section (expanded)
    "services.badge": "Nossos Servicos",
    "services.title": "Tudo que voce precisa para sua viagem perfeita",
    "services.subtitle": "Servicos premium projetados para viajantes exigentes que buscam experiencias unicas na Europa.",
    "services.directFlights": "Voos Diretos",
    "services.directFlightsDesc": "Conexoes do Brasil para as principais capitais europeias.",
    "services.boutiqueHotels": "Hoteis Boutique",
    "services.boutiqueHotelsDesc": "Hospedagens exclusivas 4 e 5 estrelas em localizacoes privilegiadas.",
    "services.carRental": "Aluguel Premium",
    "services.carRentalDesc": "Veiculos de alta gama para percorrer a Europa com total liberdade.",
    "services.esim": "eSIM Europa",
    "services.esimDesc": "Conectividade ilimitada em mais de 30 paises europeus sem complicacoes.",
    "services.vipInsurance": "Seguro VIP",
    "services.vipInsuranceDesc": "Cobertura premium com assistencia medica 24/7 e cancelamento flexivel.",
    "services.privateTours": "Passeios Privados",
    "services.privateToursDesc": "Experiencias personalizadas com guias especialistas em cada destino.",
    "services.vipTransfers": "Traslados VIP",
    "services.vipTransfersDesc": "Servico de transporte executivo aeroporto-hotel e vice-versa.",
    "services.exclusiveOffers": "Ofertas Exclusivas",
    "services.exclusiveOffersDesc": "Descontos especiais e promocoes apenas para nossos clientes.",
    
    // Blog Section
    "blog.badge": "Blog de Viagens",
    "blog.title": "Inspire-se para sua proxima viagem",
    "blog.viewAll": "Ver todos os artigos",
    "blog.readMore": "Ler mais",
    "blog.minRead": "min",
    "blog.article1.title": "Guia Completo: Visto Schengen para Brasileiros 2025",
    "blog.article1.desc": "Tudo o que voce precisa saber para solicitar seu visto europeu do Brasil.",
    "blog.article1.category": "Documentos",
    "blog.article2.title": "10 Experiencias de Luxo Imperdiveis em Paris",
    "blog.article2.desc": "Desde jantares na Torre Eiffel ate cruzeiros privados pelo Sena.",
    "blog.article2.category": "Luxo",
    "blog.article3.title": "Madrid vs Barcelona: Qual Escolher para sua Primeira Viagem?",
    "blog.article3.desc": "Comparamos ambas as cidades para ajuda-lo a decidir seu proximo destino.",
    "blog.article3.category": "Destinos",
    "blog.article4.title": "Os Melhores Hoteis Boutique de Roma",
    "blog.article4.desc": "Hospedagens charmosas que tornarao sua experiencia italiana inesquecivel.",
    "blog.article4.category": "Luxo",
    
    // VIP Club Section
    "vipClub.badge": "Junte-se ao VIP Club",
    "vipClub.title": "Receba ofertas exclusivas",
    "vipClub.subtitle": "Seja o primeiro a conhecer nossas promocoes, novos destinos e dicas de viagem.",
    "vipClub.discount": "+ 10% de desconto na sua primeira reserva",
    "vipClub.placeholder": "Seu e-mail",
    "vipClub.button": "Inscrever-se",
    "vipClub.noSpam": "Sem spam. Voce pode cancelar quando quiser.",
    "vipClub.success": "Bem-vindo ao VIP Club!",
    "vipClub.successDesc": "Voce recebera nossas melhores ofertas no seu e-mail.",
    
    // Travel Tools
    "tools.badge": "Ferramentas de Viagem",
    "tools.title": "Planeje sua Viagem",
    "tools.subtitle": "Acesse nossas ferramentas gratuitas para planejar sua viagem sem complicacoes.",
    "tools.calculate": "Calcular",
    "tools.solvency.tab": "Solvencia",
    "tools.solvency.title": "Calculadora de Solvencia Europeia",
    "tools.solvency.desc": "Calcule o valor minimo que voce precisa comprovar de acordo com os dias de sua viagem ao espaco Schengen.",
    "tools.solvency.days": "Dias de viagem",
    "tools.solvency.country": "Pais de destino",
    "tools.solvency.selectCountry": "Selecione um pais",
    "tools.solvency.required": "Solvencia minima requerida",
    "tools.solvency.daysLabel": "dias",
    "tools.solvency.note": "Este calculo e orientativo. Os requisitos podem variar de acordo com o consulado e sua situacao pessoal.",
    "tools.calculator.tab": "Calcular Viagem",
    "tools.calculator.title": "Calculadora de Viagem",
    "tools.calculator.desc": "Obtenha uma estimativa de custos para sua proxima viagem a Europa.",
    ...
    "tools.calculator.hotels": "Hoteis",
    "tools.calculator.expenses": "Gastos diarios",
    "tools.calculator.estimated": "Custo total estimado",
    "tools.calculator.note": "Precos estimados em USD. Podem variar de acordo com temporada e disponibilidade.",
    "tools.visa.tab": "Verificar Visto",
    "tools.visa.title": "Verificador de Visto",
    "tools.visa.desc": "Verifique se voce precisa de visto para seu proximo destino na Europa.",
    "tools.visa.nationality": "Sua nacionalidade",
    "tools.visa.selectNationality": "Selecione a nacionalidade",
    "tools.visa.destination": "Pais de destino",
    "tools.visa.selectDest": "Selecione o destino",
    "tools.visa.check": "Verificar requisitos",
    "tools.visa.required": "Visto necessario",
    ...
    "tools.tracker.flightNumber": "Numero do voo",
    "tools.tracker.track": "Rastrear voo",
    "tools.tracker.enterFlight": "Insira um numero de voo para ver seu status atual.",
    
    // Policies
    "policies.badge": "Politicas",
    "policies.title": "Politicas e Termos",
    "policies.subtitle": "Conheca nossas politicas de servico, cancelamentos e reembolsos.",
    "policies.terms": "Termos e Condicoes",
    "policies.cancellations": "Cancelamentos",
    "policies.refunds": "Reembolsos",
    "policies.returns": "Devolucoes",
    
    // Complete Your Trip
    "completeTrip.badge": "Viaje Tranquilo",
    "completeTrip.title": "Complete sua Viagem com a Trips Europa",
    "completeTrip.subtitle": "Nossos consultores acompanham voce desde o planejamento ate o retorno, garantindo que cada detalhe da sua viagem seja perfeito.",
    "completeTrip.advisor.title": "Consultores Personalizados",
    "completeTrip.advisor.desc": "Acompanhamos voce desde o planejamento ate seu retorno, cuidando de cada detalhe.",
    "completeTrip.complete.title": "Viagem Completa",
    "completeTrip.complete.desc": "Voos, hospedagem e atividades projetadas sob medida em um so lugar.",
    "completeTrip.insurance.title": "Seguro Incluido",
    "completeTrip.insurance.desc": "Viaje protegido com seguros de viagem e bagagem incluidos em todos os nossos pacotes.",
    "completeTrip.support.title": "Suporte 24/7",
    "completeTrip.support.desc": "Estamos disponiveis 24 horas para qualquer emergencia ou consulta durante sua viagem.",
    "completeTrip.luggage": "Bagagem incluida em todos os nossos voos",
    
    // Strategic Alliances
    "alliances.badge": "Aliancas Estrategicas",
    "alliances.title": "Trabalhamos com os Melhores",
    "alliances.subtitle": "Nossas aliancas com companhias aereas e fornecedores de primeiro nivel garantem a melhor experiencia para sua viagem.",
    "alliances.paymentMethods": "Metodos de pagamento aceitos",
    
    // WhatsApp
    "whatsapp.message": "Ola, tenho interesse em informacoes sobre viagens para a Europa",
