...
const PACKAGES_MEXICO = [
  {
    id: "europa-express-mx",
    title: "Europa Express desde CDMX",
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 345,
    image: "https://images.unsplash.com/photo-1543783207-ec64e4d95325?q=70&w=800&auto=format&fit=crop",
    featured: true,
  },
  {
    id: "italia-gastronomica-mx",
    title: "Italia Gastronomica desde Guadalajara",
    destinations: ["Roma", "Florencia", "Bolonia", "Venecia"],
    days: 12,
    price: 2800,
    priceMXN: 50400,
  ...
  {
    id: "capitales-europeas-mx",
    title: "Capitales Europeas desde Monterrey",
    destinations: ["Londres", "Paris", "Amsterdam", "Bruselas"],
    days: 15,
    price: 3200,
    priceMXN: 57600,
    departure: "Monterrey",
...
export default function FromMexico() {
  ...
  const content = {
    ...
    stats: {
      travelers: { es: "4,100+ viajeros mexicanos", en: "4,100+ Mexican travelers" },
      rating: { es: "4.9 calificacion", en: "4.9 rating" },
      cities: { es: "6 ciudades de salida", en: "6 departure cities" },
    },
