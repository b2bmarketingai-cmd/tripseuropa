...
const DESTINATIONS_BY_CITY: Record<string, DestinationRoute[]> = {
  bogota: [
    { destCity: "Madrid", destCountry: "Espana", destCode: "MAD", duration: "9h 35m", connectionType: "Directo", airlines: ["Avianca", "LATAM", "Iberia"], badge: "Mas Popular" },
    ...
    { destCity: "Barcelona", destCountry: "Espana", destCode: "BCN", duration: "11-13h", connectionType: "Conexion", airlines: ["LATAM", "Iberia", "United"], badge: "Playa" },
  ...
  cdmx: [
    { destCity: "Madrid", destCountry: "Espana", destCode: "MAD", duration: "11h", connectionType: "Directo", airlines: ["Aeromexico", "Iberia"], badge: "Mas Popular" },
    ...
    { destCity: "Barcelona", destCountry: "Espana", destCode: "BCN", duration: "11-13h", connectionType: "Conexion", airlines: ["LATAM", "Iberia"] },
  ...
  "sao-paulo": [
    ...
    { destCity: "Madrid", destCountry: "Espana", destCode: "MAD", duration: "9-11h", connectionType: "Conexion", airlines: ["TAP", "LATAM", "Iberia"] },
  ...
  "buenos-aires": [
    { destCity: "Madrid", destCountry: "Espana", destCode: "MAD", duration: "11-13h", connectionType: "Conexion Miami/Sao Paulo", airlines: ["LATAM", "Iberia", "Aerolineas"], badge: "Mas Popular" },
    { destCity: "Barcelona", destCountry: "Espana", destCode: "BCN", duration: "12-15h", connectionType: "Conexion", airlines: ["LATAM", "Iberia"] },
  ...
  lima: [
    { destCity: "Madrid", destCountry: "Espana", destCode: "MAD", duration: "11h 45m", connectionType: "Directo", airlines: ["LATAM", "Iberia"], badge: "Mas Popular" },
    { destCity: "Barcelona", destCountry: "Espana", destCode: "BCN", duration: "12-14h", connectionType: "Conexion Madrid", airlines: ["LATAM", "Iberia"] },
  ...
  panama: [
    { destCity: "Madrid", destCountry: "Espana", destCode: "MAD", duration: "9h 45m", connectionType: "Directo", airlines: ["Copa", "Iberia"], badge: "Mas Popular" },
