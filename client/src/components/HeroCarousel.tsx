...
export function HeroCarousel() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0">
        <img
          src={getResponsiveImageUrl(
            CAROUSEL_SLIDES[currentSlide].imageBase,
            isMobile,
          )}
      ...
      <div
        className="absolute bottom-8 left-1/2 -translate-x-1/2 flex gap-1 z-30"
